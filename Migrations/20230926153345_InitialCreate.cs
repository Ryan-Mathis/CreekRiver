    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "ryannoahm@live.com", "Ryan", "Mathis" },
                    { 2, "ecm@gmail.com", "Ethan", "Chaz" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, 2, "https://tnstateparks.com/assets/images/hero-images/big-hill-pond.jpg", "Big Hill Pond" },
                    { 3, 3, "https://tnstateparks.com/assets/images/hero-images/burgess-falls.jpg", "Burgess Falls" },
                    { 4, 4, "https://tnstateparks.com/assets/images/hero-images/chickasaw.jpg", "Chickasaw" },
                    { 5, 1, "https://tnstateparks.com/assets/images/hero-images/cove-lake.jpg", "Cove Lake" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 3, new DateTime(2023, 8, 24, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2023, 8, 28, 0, 0, 0, 0, DateTimeKind.Unspecified), 1 },
                    { 2, 4, new DateTime(2023, 6, 23, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2023, 8, 26, 0, 0, 0, 0, DateTimeKind.Unspecified), 2 }
                });
